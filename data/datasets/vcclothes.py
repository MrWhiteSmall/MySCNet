...
class VCClothes(object):
    ...
    # dataset_dir = 'VCC_my'
    # dataset_dir = 'prcc_my'
    # dataset_dir = 'LTCC_ReID_my'
    # dataset_dir = 'DeepChangeDataset_my'
    def __init__(self, root='data',dataset_dir='VCC_my', mode='all', **kwargs):
        ...
        if 'LTCC' in self.dataset_dir:
            self.ext = '.png'  # image extension
        else:
            self.ext = '.jpg'
    ...
    def _process_dir_train(self):
        img_paths = glob.glob(osp.join(self.train_dir, f'*{self.ext}'))
        img_paths.sort()
    ...
    def _process_dir_test(self):
        query_img_paths = glob.glob(osp.join(self.query_dir, f'*{self.ext}'))
        gallery_img_paths = glob.glob(osp.join(self.gallery_dir, f'*{self.ext}'))
